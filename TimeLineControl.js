 ...
 */
function TimeLineControl(timeLineController)
{
    this.m_context = document.getElementsByTagName('canvas')[0].getContext('2d');
    this.m_canvas = document.getElementsByTagName('canvas')[0];
    ...
    this.m_timeLineController.RenderEvent.subscribe(this.onRender);
}

function TimeLineControl_dispose()
{
